    ...
    <>
      <section className="  bg-black text-gray-200">
        ...
        <div className="px-4 md:px-6 lg:px-40">
          <h1 className="text-md text-red-600 font-semibold mb-8 border-b border-red-600 py-2">
            About Us
          </h1>
          ...
          <div className="mb-10">
            <Image
              src={about1}
              alt="Team Photo"
              className="w-full h-[18rem] lg:w-full lg:h-[52rem] rounded-lg shadow-md"
            />
          </div>
          <div className="mb-4">
            <h2 className="text-sm md:text-lg text-red-600 font-semibold mb-4 border-b border-red-600 py-2">
              OUR STORY
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-12">
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-300 text-xs md:text-sm leading-relaxed text-justify ">
                <li>
